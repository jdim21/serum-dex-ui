        ...
        <>
            ...
            <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '4rem', width: '100%' }}>
                <h2 style={{ color: '#bc13fe', textAlign: 'center', paddingTop: '1rem', width: '50%' }}>
                    ...
                    as we release them, so grab a few if you enjoy the site!
                </h2>
            </div>
            <div style={{ display: 'flex', justifyContent: 'center', paddingTop: '4rem', width: '100%' }}>
                <h2 style={{ color: '#bc13fe', textAlign: 'center', paddingTop: '1rem', width: '50%' }}>
                    Follow us on Socials (find them across the footer bar of the site) for more info. Reach
                    out with any suggestions or bug reports to solanatools@protonmail.com.
                </h2>
            </div>
        </>
    );
